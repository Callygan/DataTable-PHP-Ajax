        ...
        <div class="card">
          ...
          <div class="card-body">
                ...
                <div class="form-inline">
                  <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Selectați intervalul de date</span>
                    <input id="date_rangepicker" class="form-control" type="text" name="daterange" value="01/01/2023 - 01/15/2023" />  
                  </div>
                </div>
